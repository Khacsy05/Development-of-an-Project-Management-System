                ...
                <table className="w-full border-collapse text-left text-sm">
                    <thead>
                        <tr className="bg-gray-50 border-b border-gray-100 text-gray-500 font-semibold">
                            ...
                            <th className="px-6 py-4">Đề tài đăng ký</th>
                        ...
                        {capstoneRequests.length === 0 ? (
                            ...
                            capstoneRequests.map((request, index) => (
                                <tr key={request.request_id} className="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-gray-500 max-w-xs truncate">{request.topic_title}</td>
                    ...
                    <div className="bg-[#f7f8fc] rounded-[32px] shadow-2xl overflow-hidden max-w-2xl w-full border border-gray-100 flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-8 overflow-y-auto flex-1 flex flex-col gap-6">
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-gray-200/60 shadow-sm flex flex-col gap-5">
                                ...
                                <div>
                                    <h4 className="text-[10px] font-bold text-[#8d9299] tracking-wider uppercase mb-1">Tên đề tài (PROPOSED_TITLE)</h4>
                                    <p className="text-sm font-bold text-gray-900 leading-relaxed">
                                        {selectedRequest.topic_title}
                                    </p>
                                </div>

                                <div>
                                    <h4 className="text-[10px] font-bold text-[#8d9299] tracking-wider uppercase mb-1">Công nghệ dự kiến (TECHNOLOGIES)</h4>
                                    <p className="text-sm font-bold text-gray-900">
                                        {selectedRequest.topic_technologies && selectedRequest.topic_technologies.length > 0
                                            ? selectedRequest.topic_technologies.join(', ')
                                            : 'Không có thông tin'}
                                    </p>
                                </div>

                                <div>
                                    <h4 className="text-[10px] font-bold text-[#8d9299] tracking-wider uppercase mb-1">Mô tả / Mục tiêu (PROPOSED_DESCRIPTION)</h4>
                                    <p className="text-sm font-bold text-gray-900 leading-relaxed whitespace-pre-line">
                                        {selectedRequest.topic_description && selectedRequest.topic_description.length > 0
                                            ? selectedRequest.topic_description.join('\n')
