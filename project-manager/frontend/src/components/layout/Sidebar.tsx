...
export default function Sidebar({ onLogout }: SidebarProps) {
  ...
  const rolePrefix = role === 'Student' ? '/dashboard/student' : '/dashboard/lecturer';
  ...
  const studentMenu = [
    ...
    },
    {
      ...
      items: [
        { name: 'Đăng ký doanh nghiệp', path: `${rolePrefix}/register-company`, icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          </svg>
        )},
        { name: 'Báo cáo thực tập', path: `${rolePrefix}/internship-report`, icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  const lecturerMenu = [
    {
      ...
      items: [
        ...
        { name: 'Quản lý đề tài', path: `${rolePrefix}/capstones`, icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Phê duyệt đề tài', path: `${rolePrefix}/approve`, icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  const currentMenu = role === 'Student' ? studentMenu : lecturerMenu;
